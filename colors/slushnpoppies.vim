...
hi CursorLine  guifg=NONE guibg=#cfcfcf gui=NONE
hi CursorColumn  guifg=NONE guibg=#cfcfcf gui=NONE
...
hi IncSearch  guifg=NONE guibg=#acc1d6 gui=NONE
hi Search  guifg=NONE guibg=#acc1d6 gui=NONE
hi Directory  guifg=NONE guibg=NONE gui=NONE
hi Folded  guifg=#406040 guibg=#f1f1f1 gui=NONE
...
hi NonText  guifg=#bfbfbf guibg=#cfcfcf gui=NONE
...
hi SpecialKey  guifg=#bfbfbf guibg=#cfcfcf gui=NONE
